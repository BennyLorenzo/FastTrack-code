const students = [
  ...
  const filterSudentsByFaculty = (array, faculty) => array.filter(student => student.faculty === faculty)

  console.log(filterSudentsByFaculty(students, "Chemijos fakultetas"))